...
const translations = {
  ...
  ar: {
    ...
    //hero
    AboutT : 'أنا باديس',
    AboutS : 'مطور مبتدئ مهتم بشدة بتطوير الويب الكامل، والشبكات، والأمن السيبراني، والأتمتة. أستمتع بتحويل الأفكار إلى رمز نظيف ومتجاوب وتعلم تقنيات جديدة على طول الطريقأركز على بناء حلول عملية، وتحسين مهاراتي، والنمو لأصبح محترفًا متعدد الجوانب',
    //hero
    //About Page
