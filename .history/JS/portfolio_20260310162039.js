...
const translations = {
  ...
  ar: {
    ...
    serTitle : 'خدماتي',
    serSub : ' .لمساعدتك على تحقيق أهدافك<br>استكشف مجموعة الخدمات التي أقدمها',// innerHTML
    //hero
    //Services Page
    ...
    contactSub : .لمساعدتك على تحقيق أهدافك<br>استكشف مجموعة الخدمات التي أقدمها, // innerHTML
    //contact-hero
