...
const translations = {
  ...
  en: {
    ...
    pointw7 : '<strong>Visual Consistency:</strong> Harmonized colors, typography, and spacing for a cohesive brand identity.',// innerHTML// innerHT
...
// web innerHtml list
const WebHtmlKeys = ['HeroTitle', 'SkillBar1', 'SkillBar2', 'SkillBar3', 'SkillBar4', 'OfferSub', 'contactnav', 'contactSub', 'FormNameL', 'FormEmailL', 'FormML', 'pointw1', 'pointw2', 'pointw3', 'pointw4', 'pointw5', 'pointw6', 'pointw7', 'pointw8', 'pointw9', 'pointw10', 'pointw11', 'pointw12'];
// web innerHtml list
