...
const translations = {
  ...
  en: {
    ...
    Tweb2 : '🎨 UI/UX Design',
    Sweb2 : 'UI/UX design focuses on creating interfaces that are intuitive, engaging, and user‑centered. We blend aesthetics with functionality to deliver experiences that feel effortless',
    //card1
    //web
    //serv content
    //Services Page
