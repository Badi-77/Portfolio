...
const translations = {
  ...
  en: {
    ...
    pointw1 : '<strong>Fluid Layouts:</strong> Flexible grids and containers that adjust automatically to different screen sizes.',
    pointw2 : '<strong>Adaptive Images:</strong> Media that scales gracefully without distortion or loss of quality.',
    pointw3 : '<strong>Mobile‑First Approach:</strong> Prioritizing usability and performance on smaller screens before scaling up to larger ones.',
    pointw4 : '<strong>Consistent Experience:</strong> Harmonized typography, spacing, and interactions across all devices.',
    ...
    pointw5 : '<strong> User‑Focused Layouts:</strong> Designs built around user needs, ensuring clarity and ease of navigation.',
    pointw6 : '<strong> Interactive Elements:</strong> Buttons, forms, and animations that guide users naturally through the journey.',
    pointw7 : '<strong>Visual Consistency:</strong> Harmonized colors, typography, and spacing for a cohesive brand identity.',
    pointw8 : '<strong>Accessibility Standards:</strong> Inclusive design practices that make interfaces usable for everyone.',
...
const HtmlKeys = ['HeroTitle', 'SkillBar1', 'SkillBar2', 'SkillBar3', 'SkillBar4', 'OfferSub', 'contactnav', 'contactSub', 'FormNameL', 'FormEmailL', 'FormML', 'serSub'];
