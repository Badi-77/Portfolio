...
const translations = {
  ...
  ar: {
    // intro
    IntroTitle : 'باديس',
    IntroSub : 'أهلاً بكم في معرض أعمالي',
    // intro
    ...
    HeroSub : 'مطور برامج شغوف، ومهندس شبكات، ومتحمس للأمن السيبراني - أعمل على بناء وحماية أنظمة رقمية مرنة. يحول التحديات إلى فرص للابتكار والتأمين والإبداع الهادف.',
    // hero
