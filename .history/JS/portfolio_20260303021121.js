...
document.getElementById('lang-toggle').addEventListener('click', ()=>{
  ...
  document.getElementById('contbtn').textContent= CurrentLang === 'en'? 'CONTACT ME' : '<i class="fas fa-download me-2"></i>تواصل معي';// footer button
  //update button text
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const swiperEl = document.querySelector(".mySwiper"); // get the swiper container element
