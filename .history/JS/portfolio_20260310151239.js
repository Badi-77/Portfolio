...
const translations = {
  ...
  ar: {
    ...
    //hero
    AboutT : 'أنا باديس',
    AboutS : 'مطور مبتدئ شغوف بتطوير مواقع الويب المتكاملة، والشبكات، والأمن السيبراني والأتمتة.

    أستمتع بتحويل الأفكار إلى أكواد برمجية نظيفة وسريعة الاستجابة، وأتعلم تقنيات جديدة باستمرار.
    
    أركز على بناء حلول عملية، وتطوير مهاراتي، والنمو لأصبح محترفًا متكاملًا.',
    //hero
    //About Page
