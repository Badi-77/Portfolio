...
desc1.addEventListener('shown.bs.collapse', () => {
  if (showMoreBtn) {
    showMoreBtn.textContent = translations[CurrentLang].ShowLessBtn;
  }
});

desc1.addEventListener('hidden.bs.collapse', () => {
  if (showMoreBtn) {
    showMoreBtn.textContent = translations[CurrentLang].ShowMoreBtn;
  }
});
// services page toggle
