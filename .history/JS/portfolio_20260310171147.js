...
const translations = {
  ...
  en: {
    ...
    pointw2 : '<strong>Adaptive Images:</strong> Media that scales gracefully without distortion or loss of quality.</li>',
    pointw3 : '<strong>Mobile‑First Approach:</strong> Prioritizing usability and performance on smaller screens before scaling up to larger ones.<li>',
    pointw4 : '',
