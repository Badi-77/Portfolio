...
const translations = {
  ...
  en: {
    ...
    autoSub : 'Transforming ideas into automated solutions through programming.',
    //header
  ...
  ar: {
    ...
    //header
    autoTitle : 'الأتمتة',
    autoSub : 'تحويل الفكرة إلى حلول تلقائية من خلال البرمجة.',
    //header
    ...
    pointA4 : ' <strong>التحديث الفعال من حيث التكلفة:</strong>
    //card1
