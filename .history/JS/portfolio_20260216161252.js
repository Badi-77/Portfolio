...
const translations = {
  ...
  ar: {
    ...
    HeroSub : 'مطور برامج شغوف، ومهندس شبكات، ومتحمس للأمن السيبراني - أعمل على بناء وحماية أنظمة رقمية مرنة. حول التحديات إلى فرص للابتكار والتأمين والإبداع الهادف.',
    // hero
