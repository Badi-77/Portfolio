...
const translations = {
  ...
  ar: {
    ...
    //hero
    AboutT : 'أنا باديس',
    AboutS : 'مطور مبتدئ شغوف بتطوير مواقع الويب المتكاملة، والشبكات، والأمن السيبراني والأتمتة. أستمتع بتحويل الأفكار إلى أكواد برمجية نظيفة وسريعة الاستجابة، وأحرص على تعلم تقنيات جديدة باستمرار. أركز على بناء حلول عملية، وتطوير مهاراتي، والنمو لأصبح محترفًا متكاملً.ا',
    //hero
    //About Page
    ...
    contactSub : '.دعنا نتواصل ونحول رؤيتك إلى واقع <br> هل لديك مشروع في ذهنك؟', // innerHTML
    //contact-hero
...
const HtmlKeys = ['HeroTitle', 'SkillBar1', 'SkillBar2', 'SkillBar3', 'SkillBar4', 'OfferSub', 'contactnav', 'contactSub', 'FormNameL', 'FormEmailL', 'FormML'];
