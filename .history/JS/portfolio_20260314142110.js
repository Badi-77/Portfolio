...
const translations = {
  ...
  ar: {
    ...
    pointw9 : '<strong> تحسين الأداء:</strong> .تقنيات تحافظ على سرعة التطبيقات، حتى في ظل الأحمال الثقيلة',// innerHTML
    pointw9 : '<strong> سهولة الصيانة:</strong> .كود نظيف وموثق جيدًا يمكن للفرق فهمه وتطويره',// innerHTML
    pointw9 : '<strong> جاهز للمستقبل:</strong> Built with flexibility to integrate new features and technologies seamlessly.',// innerHTML
    Sweb6 : 'By prioritizing scalability, we ensure your software grows with your ambitions. Our code is designed to stay reliable, efficient, and adaptable over time',
    //card3
    //web
